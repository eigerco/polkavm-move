...
pub fn test_multi_module_call() -> anyhow::Result<()> {
    initialize_logger();
    let (mut instance, mut allocator) = new_move_program(
        "output/multi_module/multi_module_call.polkavm",
